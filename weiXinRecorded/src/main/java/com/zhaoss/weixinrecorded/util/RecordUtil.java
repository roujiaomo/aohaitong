...
public class RecordUtil {
    ...
    private final ArrayBlockingQueue<byte[]> videoQueue = new ArrayBlockingQueue<>(3);
    ...
    private final OnPreviewFrameListener mOnPreviewFrameListener = new OnPreviewFrameListener() {
        @Override
