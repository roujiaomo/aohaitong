...
public class RecordedActivity extends BaseActivity {
    ...
    public static final String INTENT_MAX_RECORD_TIME = "result_data_type";
    ...
    public static float MAX_VIDEO_TIME = 5f * 1000;  //最大录制时间
    public static float MIN_VIDEO_TIME = 2f * 1000;  //最小录制时间
    ...
    private final ArrayList<String> segmentList = new ArrayList<>();//分段视频地址
    private final ArrayList<String> aacList = new ArrayList<>();//分段音频地址
    private final ArrayList<Long> timeList = new ArrayList<>();//分段录制时间

    //是否在录制视频
    private final AtomicBoolean isRecordVideo = new AtomicBoolean(false);
    //拍照
    private final AtomicBoolean isShotPhoto = new AtomicBoolean(false);
    ...
    private void shotPhoto(final byte[] nv21) {
        ...
        RxJavaUtil.run(new RxJavaUtil.OnRxAndroidListener<String>() {
            ...
            public String doInBackground() throws Throwable {
                ...
                String photoPath = LanSongFileUtil.DEFAULT_DIR + System.currentTimeMillis() + ".jpg";
...
//                finish();
    ...
    private void initData() {
        ...
        MAX_VIDEO_TIME = intent.getIntExtra(INTENT_MAX_RECORD_TIME, 5);
                ...
                try {
                    ...
                    if (f.exists()) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(RecordedActivity.this, "视频录制失败, 请重试!", Toast.LENGTH_SHORT).show();
                            }
                        });
                        finish();
                    }
