...
import com.aohaitong.databinding.ItemTextReceiveBinding
...
/**
 * 接受方数据item 只做时间和内容的显示
 */
class ChatReceiveTextItem(
    private val viewModel: ChatViewModel,
    private val lifecycleOwner: LifecycleOwner,
    private val chatMsgBusinessBean: ChatMsgBusinessBean,
    private var context: Context
) :
    BindableItem<ItemTextReceiveBinding>() {
    override fun bind(viewBinding: ItemTextReceiveBinding, position: Int) {
     ...
     */
    private fun handleUserHeader(viewBinding: ItemTextReceiveBinding, isGroup: Boolean) {
        if (isGroup) {
    ...
    override fun getLayout() = R.layout.item_text_receive

    override fun initializeViewBinding(view: View): ItemTextReceiveBinding =
        ItemTextReceiveBinding.bind(view)

    override fun isSameAs(other: Item<*>): Boolean {
        return other is ChatReceiveTextItem
    }

    override fun hasSameContentAs(other: Item<*>): Boolean {
        return other is ChatReceiveTextItem && other.chatMsgBusinessBean.id == chatMsgBusinessBean.id
