...
import com.aohaitong.databinding.ItemImageReceiveBinding
...
class ChatReceivedImageOrVideoItem(
    private val viewModel: ChatViewModel,
    private val lifecycleOwner: LifecycleOwner,
    private val chatMsgBusinessBean: ChatMsgBusinessBean,
    private var context: Context,
) :
    BindableItem<ItemImageReceiveBinding>() {
    override fun bind(viewBinding: ItemImageReceiveBinding, position: Int) {
...
//    }
     ...
     */
    private fun handleUserHeader(viewBinding: ItemImageReceiveBinding, isGroup: Boolean) {
        if (isGroup) {
    ...
    override fun getLayout() = R.layout.item_image_receive


    override fun initializeViewBinding(view: View): ItemImageReceiveBinding =
        ItemImageReceiveBinding.bind(view)


    override fun isSameAs(other: Item<*>): Boolean {
        return other is ChatReceivedImageOrVideoItem
    }
    ...
    override fun hasSameContentAs(other: Item<*>): Boolean {
        return other is ChatReceivedImageOrVideoItem && other.chatMsgBusinessBean.id == chatMsgBusinessBean.id
