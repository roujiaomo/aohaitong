...
public class BinArray {
     ...
     *
     * @param bitsRequired the minimum acceptable number of bits.
     */
    ...
    public String getAsciiString() throws SixbitException {
    ...
    public String getAsciiString(int len) throws SixbitException {
        int endLength = readPtr + len * 8;
        StringBuilder buf = new StringBuilder();
        int to = readPtr + 8 - 1;
        while (to < endLength) {
            long res = getVal(readPtr, to);
