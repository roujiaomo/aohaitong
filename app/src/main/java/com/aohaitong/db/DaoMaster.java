...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        BroadBeanDao.createTable(db, ifNotExists);
        ChatMsgBeanDao.createTable(db, ifNotExists);
        ContactsBeanDao.createTable(db, ifNotExists);
        FriendApplyBeanDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        BroadBeanDao.dropTable(db, ifExists);
        ChatMsgBeanDao.dropTable(db, ifExists);
        ContactsBeanDao.dropTable(db, ifExists);
        FriendApplyBeanDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(BroadBeanDao.class);
        registerDaoClass(ChatMsgBeanDao.class);
        registerDaoClass(ContactsBeanDao.class);
        registerDaoClass(FriendApplyBeanDao.class);
